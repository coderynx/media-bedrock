...
namespace MediaBedrock.Controller.UnitTests.JobRuns;
...
public sealed class JobRunFactoryTests
{
    ...
    public async Task CreateAsync_ShouldCreateInputAssets_WhenJobHasInputs()
    {
        ...
        await _mediaInformationRetriever.Received(2).RetrieveAsync(Arg.Any<string>());
    }
    ...
    public async Task CreateAsync_ShouldHandleJobWithNoInputs()
    {
        ...
        await _mediaInformationRetriever.DidNotReceive().RetrieveAsync(Arg.Any<string>());
    }
