...
public static class JobRunErrorCodes
{
    ...
    public const string StepNotReadyToRun = "JobRun.StepNotReadyToRun";
}
...
public static class JobRunErrors
{
    ...
    public static Error StepNotReadyToRun(JobRunStepId jobRunStepId)
    {
        return Error.InvalidInput(
            code: JobRunErrorCodes.StepNotReadyToRun,
            message: $"The job run step with id {jobRunStepId} is not ready to run.");   
    }
}