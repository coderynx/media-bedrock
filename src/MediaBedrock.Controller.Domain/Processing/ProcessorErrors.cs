...
namespace MediaBedrock.Controller.Domain.Processing;

public static class ProcessorErrorCodes
{
    public const string InvalidInstanceId = "Processor.InvalidInstanceId";
...
{
    public static Error InvalidInstanceId(Guid value)
    {
        return Error.InvalidInput(
            code: ProcessorErrorCodes.InvalidInstanceId,
